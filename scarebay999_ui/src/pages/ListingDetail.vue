						...
						<td style="width: 100%;"></td>
				        	...
				        	<td style="width: 150px;">
								...
								<div id="app">
								  ...
								  <base-input label="StartingBid" type="text" placeholder="Enter StartingBid" v-model="listingToAdd.startingBid"></base-input>
								  <base-input label="AuctionEndDate" type="text" placeholder="Enter AuctionEndDate" v-model="listingToAdd.auctionEndDate"></base-input>
												                  </form>
								                </div>
            ...
            <div style="text-align: center; padding: 20px;">
              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Starting Bid</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="StartingBid" type="text" placeholder="Enter StartingBid" v-model="listingDetails.startingBid"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Auction End Date</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<datepicker v-model="listingDetails.auctionEndDate"  placeholder="Select Date" ></datepicker>
																		</div>
						</td>
														</tr>
